...
<div style="text-align: center; margin-top: 30px;">
  ...
  <p style="font-family: 'Georgia', serif; font-size: 1.1em; color: #555; line-height: 1.6;">
    More information about the physics book for children coming soon!
  </p>

  <div style="margin-top: 20px;">
    <img src="{{ site.baseurl }}/assets/images/books/lajka.jpeg" 
         alt="Majka and Łajka" 
         style="width: 100%; max-width: 400px; height: auto; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px;">
    <p style="font-family: 'Georgia', serif; font-size: 0.9em; color: #777; margin-top: 10px;">
      <em>"Majka and Łajka"</em>, illustration by 
      <a href="https://www.instagram.com/eve_me_18/" target="_blank" style="color: #0077cc;">Eve</a>.
    </p>
  </div>
